...
dan_cal256_on_cifar10 = np.load('./Result/DAN_cal256_on_CIFAR10.npy')
...
print(dan_cal256_on_cifar10.shape)
...
plt.plot(x, np.lib.pad(dan_cal256_on_cifar10[:,1], (0,7), 'constant', constant_values = (0,dan_cal256_on_cifar10[-1,-1])), label='DAN_cal256 on CIFAR10')
...
plt.plot(x, vggb_s_on_cifar10[:, 1], label='VGGB_S on CIFAR10')
plt.legend()
